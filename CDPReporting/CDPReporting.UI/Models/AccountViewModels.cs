...
namespace CDPReporting.UI.Models
{
    ...
    public class LogOnModel
    {
        ...
        [StringLength(30, ErrorMessage = "{0} can't exceed {1} characters length")]
    ...
    public class RegisterModel
    {
        ...
        public PlantResult Plants { get; set; }

        public string DisplayName { get; set; }
        public Boolean IsADDetailFetched { get; set; }
    }
    ...
    public interface IMembershipService
    {
        ...
        MembershipCreateStatus CreateUser(string userName, string password, string email, Guid? PlantId);
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus CreateUser(string userName, string password, string email, Guid? PlantId)
        {
            if (String.IsNullOrEmpty(userName)) throw new ArgumentException("Value cannot be null or empty.", "userName");
            if (String.IsNullOrEmpty(password)) throw new ArgumentException("Value cannot be null or empty.", "password");
            ...
            SMR.KM.Security.Security.KMExtendedProvider provider = Membership.Provider as SMR.KM.Security.Security.KMExtendedProvider;
            provider.CreateUser(userName, password, email, PlantId, null, null, true, null, out status);
            return status;
        }
